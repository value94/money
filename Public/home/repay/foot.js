		...
		if (a.status == 1) {
			if(a.muban==0)
			{
				...
				creathtml0(function(){
					...
					if(a.isshowTran==1){$("#second_page").hide();}else{$("#first_page").hide();$("#appMs").text(a.appN);}
				});
			}
